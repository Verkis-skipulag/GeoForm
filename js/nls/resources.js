define({
  root: ({
    ...
    configure: {
      ...
      sharedlg: {
        items: {},
        mailtoLinkDescription: "Hér er hlekkur á skráninguna"
      }
    },
    user: {
      all: "All",
      ...
      locationDescriptionForNoOption: "Veljið staðsetningu með því að smella á kortið.",
      addressText: "Leita",
      ...
      shareUserTitleMessage: "Takk fyrir að taka þátt",
      entrySubmitted: "Skráningu er lokið.",
      shareThisForm: "Deila skráningarformi",
      shareUserTextMessage: "Segðu öðrum frá með því að deila á:",
      addAttachmentFailedMessage: "Ekki hægt að setja inn viðhengið",
      ...
      placeholderLatitude: "Lengd (Y)",
      placeholderLongitude: "Breidd (X)",
      latitude: "Lengd",
      longitude: "Breidd",
      ...
      invalidString: "Staðfestið valið gildi.",
    ...
    viewer: {
      ...
      aboutUsTabTooltip: "Vefsjá vegna endurskoðunar aðalskipulags. Hugmyndir og ábendingar",
      mapTabTooltip: "Map",
